    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 1, 15, 17, 26, 49, 205, DateTimeKind.Local).AddTicks(8945), 200000m, 100000m });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi-VN", "Áo nam", "ao-nam", "Sản phẩm áo thời trang nam", "" },
                    { 3, 2, "vi-VN", "Áo nữ", "ao-nu", "Sản phẩm áo thời trang nữ", "" },
                    { 2, 1, "en-US", "Men Shirt", "men-shirt", "The shirt product for men", "" },
                    { 4, 2, "en-US", "Women Shirt", "women-shirt", "The shirt product for women", "" }
                });
